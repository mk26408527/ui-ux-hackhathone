      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="space-y-4">
            ...
            <RadioGroup defaultValue="purple" className="flex gap-2">
              {[
          ...
          <div className="flex gap-4 items-center">
            <div className="flex items-center border rounded-md">
              <Button variant="ghost" size="icon" className="rounded-none" onClick={() => updateQuantity(quantity - 1)}>
          ...
          <div className="space-y-2 pt-4 border-t">
            <p className="text-sm">SKU: <span className="text-muted-foreground">SS001</span></p>
            <p className="text-sm">Category: <span className="text-muted-foreground">Sofas</span></p>
            <p className="text-sm">Tags: <span className="text-muted-foreground">Sofa, Chair, Home, Shop</span></p>
          </div>
